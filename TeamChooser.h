...
public:
    TeamChooser(QWidget* parent = nullptr) : QWidget(parent)
    {
        ...
        this->blueTeam->setStyleSheet("background-color: #4D83A1; border-radius: 40px; margin-top: 20px;");
        this->yellowTeam = new QPushButton("Equipe Jaune", this);
        this->yellowTeam->setStyleSheet("background-color: #FFBF00; border-radius: 40px; margin-top: 20px;");
